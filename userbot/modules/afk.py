        ...
        try:
            if pic.endswith((".tgs", ".webp")):
                ...
                shites = await bot.send_message(
                    event.chat_id,
                    f"🍆 **ONLINE**\n**Dark {ALIVE_NAME} Kembali Online Untuk Chat Telegram**\n**Sejak :** `{total_afk_time}` **Yang Lalu**",
                )
            else:
                shite = await bot.send_message(
                    event.chat_id,
                    f"**Dark {ALIVE_NAME} Sedang AFK!**\n\n**Sejak :** `{total_afk_time}` **Yang Lalu**",
                    file=pic,
                )
        except BaseException:
            shite = await bot.send_message(
                event.chat_id,
                f"🍆 **ONLINE**\n**Dark {ALIVE_NAME} Kembali Online**\n**Sejak :** `{total_afk_time}` **Yang Lalu**",
            )
        ...
        if reason:
            ...
            try:
                if pic.endswith((".tgs", ".webp")):
                    await bot.send_message(event.chat_id, file=pic)
                    await bot.send_message(
                        event.chat_id, f"**Dark {ALIVE_NAME} Telah AFK...**"
                    )
                else:
                    await bot.send_message(
                        event.chat_id,
                ...
                await bot.send_message(event.chat_id, f"**Dark {ALIVE_NAME} Telah AFK...**")
        await event.delete()
        try:
            if reason and pic:
                if pic.endswith((".tgs", ".webp")):
